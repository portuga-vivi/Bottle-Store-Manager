...
require_once "ConexaoPHP/db.php";
include ('ConexaoPHP/create_table.php');
...
.product-card img{ max-width:140px; }
.product-title{ font-weight:800; margin-top:10px; }
</style>
</head>
...
<div id="categoryModal" class="cat-modal">
  <div class="cat-box">
    <span class="cat-close" onclick="closeCategoryModal()">×</span>
    <h1>Selecione o que deseja vender</h1>
    <h2 id="modalToday"></h2>

    <div class="product-grid">
      <div class="product-card" onclick="goToSection('cervejas')">
        <img src="Pics/cervejas.png"><div class="product-title">Cervejas</div>
      </div>
      <div class="product-card" onclick="goToSection('cidras')">
        <img src="Pics/Cidras.png"><div class="product-title">Cidras</div>
      </div>
      <div class="product-card" onclick="goToSection('secas')">
        <img src="Pics/secas.png"><div class="product-title">Secas</div>
      </div>
      <div class="product-card" onclick="goToSection('vinhos')">
        <img src="Pics/Vinhos.png"><div class="product-title">Vinhos</div>
      </div>
      <div class="product-card" onclick="goToSection('outras_bebidas')">
        <img src="Pics/refrigerantes.png"><div class="product-title">Outras Bebidas</div>
      </div>
      <div class="product-card" onclick="goToSection('outros_produtos')">
        <img src="Pics/outros.png"><div class="product-title">Outros</div>
      </div>
    </div>
  </div>
</div>
...
window.addEventListener("load",()=>{
  document.getElementById("modalToday").innerText="Data: "+new Date().toLocaleDateString("pt-PT");
});
</script>
...
<header class="top-header">
  ...
  <h1 class="logo">NA <span>BOTTLE</span></h1>
</a>

    <a href="login/logout.php" class="brand" style = "color: #ffffff;">
...
<section id="cervejas">
  ...
  <h2 class="section-title">SECAS</h2>
  <div class="image-row">
  <?php if ($result && $result->num_rows > 0): ?>
    <?php while ($row = $result->fetch_assoc()): ?>
      <div class="image-box"
...
async function syncQueuedSales() {
  ...
  try {
    ...
    for (const row of list) {
      ...
      const r = await fetch("vendas/compra/insert.php", {
        method: "POST",
